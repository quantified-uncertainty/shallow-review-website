                ...
                return (
                  <Link
                    ...
                    className={cn(
                      ...
                      isActive ? `${colors.bgLight}` : "hover:bg-slate-50"
                    )}
                    onClick={onNavigate}
                  >
                    <span
                      className={cn(
                        "w-1.5 h-1.5 rounded-full flex-shrink-0 transition-transform",
                        colors.dot,
                        isActive && "scale-150"
                      )}
                    />
                    <span
                      className={`text-sm font-display font-black ${colors.text}`}
                    >
